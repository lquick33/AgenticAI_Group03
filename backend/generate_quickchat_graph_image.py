"""
Script to generate a visual representation of the QuickChat Agent graph.

This script creates a PNG image of the LangGraph workflow for the QuickChatAgent
...
def generate_graph_image():
    """Generate PNG image of the QuickChat Agent graph."""
    
    print("[*] Initializing QuickChat Agent...")
    ...
    try:
        agent = QuickChatAgent(
            ...
            # keyword_extraction_llm is optional and not needed for graph generation
        )
        print("[OK] QuickChat Agent initialized")
    except Exception as e:
        print(f"[ERROR] Failed to initialize QuickChat Agent: {e}")
    ...
    try:
        ...
        temp_path = "quickchat_agent_graph_temp.png"
        output_path = "quickchat_agent_graph.png"
...
if __name__ == "__main__":
    print("=" * 60)
    print("QuickChat Agent Graph Visualizer")
    print("=" * 60)
    print()
