"""
Script to generate a visual representation of the Tutor Agent graph.

This script creates a PNG image of the LangGraph workflow for the TutorAgent
...
def generate_graph_image():
    """Generate PNG image of the Tutor Agent graph."""
    ...
    # Initialize agent with a simple system prompt to avoid Langfuse dependency
    # The graph structure doesn't depend on the actual prompt content
    try:
        agent = TutorAgent(
            llm=llm,
            checkpointer=checkpointer,
            language="de",
            system_prompt="You are a helpful tutor assistant."  # Simple prompt to bypass Langfuse
        )
        print("[OK] Tutor Agent initialized")
    except Exception as e:
        print(f"[ERROR] Failed to initialize Tutor Agent: {e}")
    ...
    try:
        ...
        temp_path = "tutor_agent_graph_temp.png"
        output_path = "tutor_agent_graph.png"
...
if __name__ == "__main__":
    print("=" * 60)
    print("Tutor Agent Graph Visualizer")
    print("=" * 60)
    print()
